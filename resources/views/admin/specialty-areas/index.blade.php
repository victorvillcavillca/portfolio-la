            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="btn-group pull-right">
                    <a href="{{ route('specialty-areas.create') }}" class="pull-right btn btn-sm btn-primary"><i class="fa fa-plus"></i> @lang('button.create')</a>
                  </div>
  ...
  $(document).ready(function() {
     ...
     let table = $('#myTable').DataTable({
      ...
      $('#delete').click(function() {
        let url = 'specialty-areas/' + area_specialty_id;
