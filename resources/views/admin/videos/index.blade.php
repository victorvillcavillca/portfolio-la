            ...
            <div class="card">
                <div class="card-header">
                  ...
                  <div class="btn-group pull-right">
                    <a href="{{ route('videos.create') }}" class="pull-right btn btn-sm btn-primary"><i class="fa fa-plus"></i> @lang('button.create')</a>
                  </div>
...
@section('scripts')
  ...
  $(document).ready(function() {
     ...
     let table = $('#myTable').DataTable({
      ...
      $('#myTable tbody').on( 'click', 'a.delete_video', function (e) {
